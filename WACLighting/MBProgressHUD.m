...
- (void)layoutSubviews {
    ...
    indFrame.origin.y = floor((frame.size.height - indFrame.size.height) / 2) + self.yOffset + 15;
...
- (void)drawRect:(CGRect)rect {
    ...
    CGRect boxRect = CGRectMake(((allRect.size.width - self.width) / 2) + self.xOffset + 55,
                                ((allRect.size.height - self.height) / 2) + self.yOffset + 11, self.width/3, self.height/1.5);
